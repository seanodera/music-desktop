...
class Favourites extends ChangeNotifier {
  ...
  init() {
    ...
    _favoriteAlbums.map((e) => favoriteAlbums.add(int.parse(e)));
    _favoritePlaylists.map((e) => favoritePlaylists.add(int.parse(e)));
    _followedArtists.map((e) => followedArtists.add(int.parse(e)));
    _init = true;
  }
